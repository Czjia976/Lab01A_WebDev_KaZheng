...
def links_section():
    ...
    linkedin_link = f'<a href="{info.my_linkedin_url}" target="_blank" rel="noopener noreferrer"><img src="{info.linkedin_image_url}" alt="LinkedIn" width="75" height="75"></a>'
    st.sidebar.markdown(linkedin_link, unsafe_allow_html=True)
    st.sidebar.text("Checkout my work")
    github_link = f'<a href="{info.my_github_url}" target="_blank" rel="noopener noreferrer"><img src="{info.github_image_url}" alt="GitHub" width="65" height="65"></a>'
...
project_section(info.project_data)
